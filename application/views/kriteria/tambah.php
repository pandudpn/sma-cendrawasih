<?php echo form_open('kriteria/tambah', array('id' => 'formKriteria')); ?>
<div class="form-group row">
    <label for="nama" class="control-label col-md-3">Nama Kriteria</label>
    <div class="col-md-9">
        <input type="text" class="form-control" name="nama" placeholder="Nama Kriteria" id="nama">
    </div>
</div>
<div class="form-group row">
    <label for="bobot" class="control-label col-md-3">Bobot</label>
    <div class="col-md-9">
        <input type="number" class="form-control" id="bobot" name="bobot" placeholder="Bobot Kriteria" max="9" min="0.1" step=".0001">
    </div>
</div>
<?php echo form_close(); ?>
<div id="result"></div>
