<?php echo form_open('guru/tambah', array('id' => 'formGuru')); ?>
<div class="form-group row">
    <label for="nama" class="control-label col-md-3">Nama</label>
    <div class="col-md-9">
        <input type="text" class="form-control" name="nama" placeholder="Nama Panjang" id="nama">
    </div>
</div>
<div class="form-group row">
...
<div class="form-group row">
    ...
    <div class="col-md-9">
        <input type="text" class="form-control" id="bidang" name="bidang" placeholder="Bidang Studi Pelajaran">
    </div>
</div>
<div class="form-group row">
    <label for="alamat" class="control-label col-md-3">Alamat</label>
    <div class="col-md-9">
        <input type="text" class="form-control" id="alamat" name="alamat_gue" placeholder="">
    </div>
</div>
<?php echo form_close(); ?>
<div id="result"></div>
